...
CommunicationReceiver::CommunicationReceiver(string ownerModule, string portIn, string envelope, int expNo, string loggingConf, string statisticConf, int n_threads) {
	mOwnerModule = ownerModule;

	mEnvelope = envelope;
	mContext = new zmq::context_t(n_threads);
